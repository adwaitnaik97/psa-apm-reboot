...
// The heading is inputted in the vehicle frame
// 
...
public:
	...
	double MagneticHeadingTov; // Time of validity value is dependent on the TimeReferenceMode
	...
	float MagneticVariation; // [rad] Magnetic Variation, commonly refered to as Geomagnetic Declination angle
};
