...
struct hgnsi_message_word2_t
{
	...
	bool GPS_CHANNEL_STATUS_2501_SET; // Bit 8 : Enable 0x2501 - DO NOT USE [Reserved]
	bool GPS_ALMANAC_2511_SET; // Bit 9 : Enable 0x2511 - DO NOT USE [Reserved]
	bool GPS_EPHEMERIS_2512_SET; // Bit 10 : Enable 0x2512 - DO NOT USE [Reserved]
	bool GPS_ONAV_2513_SET; // Bit 11 : Enable 0x2513 - DO NOT USE [Reserved]
	bool GPS_IONO_2514_SET; // Bit 12 : Enable 0x2514 - DO NOT USE [Reserved]
	...
	bool IBIT_RESULTS_2601; // Bit 16 : Enable 0x2601 - DO NOT USE [Reserved]
	...
	bool APP_SP_OUTPUT_1_2901; // Bit 24 : Enable 0x2901 - DO NOT USE [Reserved]
	...
	void Default()
	{
		...
		GNSS_SINGLE_ANT_ATT_6112 = 1;
		VEHICLE_BODY_RATES_AND_ACCELS_6406_100HZ = 0;
		GPS_NORM_MEAS_RESID_2428_5HZ = 0;
		GPS_NORM_MEAS_RESID_2428_1HZ = 0;
		TR_NORM_MEAS_RESID_2429_5HZ = 0;
