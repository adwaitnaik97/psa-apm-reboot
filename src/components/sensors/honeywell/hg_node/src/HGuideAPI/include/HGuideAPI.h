...
#include <include/Msg_2421.h> // 0x2421 : Filter measurement status
#include <include/Msg_2422.h> // 0x2422 : Filter Navigation Error Values
...
#include <include/Msg_6009.h> // 0x6009 : Ntrip Configuration
...
#include <include/Msg_6111.h> // 0x6111 : Results of Motion detection algorithm
...
#include <include/Msg_6438.h> // 0x6438 : Filter Calibration Of Odometer Inputs
...
#include <include/Msg_6609.h> // 0x6609 : Ntrip Status
...
#include <include/Msg_6738.h> // 0x6738 : DVL Filter Data
...
#include <include/Msg_B0.h> // 0xB0 : 1Hz Status Message
#include <include/Msg_B1.h> // 0xB1 : Control Message
#include <include/Msg_B2.h> // 0xB2 : Guidance Message
#include <include/Msg_B3.h> // 0xB3 : Magnetometer Message
#include <include/Msg_B4.h> // 0xB4 : Attitude Message
#include <include/Msg_CA.h> // 0xCA : Control Message
#include <include/Msg_F0.h> // 0xF0 : Status Message - Device Type
#include <include/Msg_F1.h> // 0xF1 : Status Message - Serial Number
#include <include/Msg_F2.h> // 0xF2 : Status Message - Hardware Information
#include <include/Msg_F3.h> // 0xF3 : Status Message - Software Information
#include <include/Msg_F4.h> // 0xF4 : Status Message - Port Information
#include <include/Msg_F5.h> // 0xF5 : Status Message - Gyro Configuration
#include <include/Msg_F6.h> // 0xF6 : Status Message - Accel Configuration
#include <include/Msg_F7.h> // 0xF7 : Status Message - Operation Information
#include <include/Msg_F8.h> // 0xF8 : Status Message - Power Information
#include <include/Msg_F9.h> // 0xF9 : Status Message - CPU Utilization
#include <include/Msg_FA.h> // 0xFA : Status Message - Sensor Health
#include <include/Msg_FB.h> // 0xFB : Status Message - BIT Health
