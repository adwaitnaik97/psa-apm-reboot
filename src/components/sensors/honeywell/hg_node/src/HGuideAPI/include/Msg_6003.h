...
public:
	...
	float VehicleEulerAnglesRoll; // [rad] VEHICLE_BODY to CASE installation attitude - roll
	float VehicleEulerAnglesPitch; // [rad] VEHICLE_BODY to CASE installation attitude - pitch
	float VehicleEulerAnglesTrueHeading; // [rad] VEHICLE_BODY to CASE installation attitude - heading
