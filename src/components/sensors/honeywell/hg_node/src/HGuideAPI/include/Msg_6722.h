#ifndef __HGuideAPI_Msg_6722_h__
#define __HGuideAPI_Msg_6722_h__
#pragma once
...
public:
	...
	static const uint32_t MessageId = 0x6722; // Message ID
...
#endif // __HGuideAPI_Msg_6722_h__
