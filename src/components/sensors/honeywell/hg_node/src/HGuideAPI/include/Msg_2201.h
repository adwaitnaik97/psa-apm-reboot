...
struct time_validity_bits_t
{
	...
	// PPS Mode of operation:
 	// 0 = Disabled
 	// 1 = Linked to Event IN 
 	// 2 = GNSS Pass-through - GPS Time 
 	// 3 = GNSS Pass-through - UTC Time
 	// 4 = Linked to internal System Time
	uint8_t PPS_Mode;
...
//
// This message is used to provide accurate time of the PPS output
...
public:
	...
	double ins_gps_internal_system_time_pps_in; // [s] INS time of PPS or event input
	double gps_time_pps_in; // [s] GPS Time of PPS or event input
