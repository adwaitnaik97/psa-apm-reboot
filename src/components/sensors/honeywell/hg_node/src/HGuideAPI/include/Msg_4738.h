...
//
// Message to input DVL filter configuration and beam leverarm and rotation.
// 
...
public:
	...
	float measNoise; // [m] Measurement noise - stdv of noise on DVL used by the filter
	float measRejectThreshold; // [sigma] Measurement rejection threshold - rejection threshold for DVL measurements used by the filter
