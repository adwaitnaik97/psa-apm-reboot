...
{
	uint8_t Position; // 0 = Unknown, 1 = External Input, 2 = GPS, 3 = Seeded Restart Data
	uint8_t Velocity; // 0 = Unknown, 1 = External Input, 2 = GPS, 3 = Seeded Restart Data, 4 = Zero Velocity
	uint8_t Attitude; // 0 = Unknown, 1 = External Input, 2 = GPS, 3 = Seeded Restart Data, 4 = Coarse Leveling
	uint8_t Heading; // 0 = Unknown, 1 = External Input, 2 = Dual Antenna GNSS, 3 = GNSS Course Over Ground, 4 = Magnetometer, 5 = Seeded Restart Data
...
public:
	...
	uint32_t Num_antennas; // Number of antennas used during Navigation Init
};
