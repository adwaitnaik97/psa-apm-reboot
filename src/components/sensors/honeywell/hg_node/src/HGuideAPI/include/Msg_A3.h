#ifndef __HGuideAPI_Msg_A3_h__
#define __HGuideAPI_Msg_A3_h__
#pragma once
...
// 0xA3 : Navigation Message without Control Data
//
// It contains the Delta Angle in Rad and Delta Velocity in m/s however no Control Data
// 
class HGUIDE_DLL Msg_A3
{
public:
	Msg_A3();
...
public:
	...
	static const uint8_t MessageID = 0xA3; // Message ID
