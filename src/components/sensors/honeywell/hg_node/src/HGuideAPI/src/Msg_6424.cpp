...
const uint32_t Msg_6424::AddressId;
const uint32_t Msg_6424::MessageId;
const uint32_t Msg_6424::MessageLength;
...
void Msg_6424::Default()
{
	...
	gnss_att_brsght_state_x = 0;
	gnss_att_brsght_state_y = 0;
	gnss_att_brsght_state_z = 0;
	gnss_att_brsght_x_stdv = 0;
	gnss_att_brsght_y_stdv = 0;
	gnss_att_brsght_z_stdv = 0;
	gps_position_state_x_stdv = 0;
	gps_position_state_y_stdv = 0;
	gps_position_state_z_stdv = 0;
...
bool Msg_6424::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(100);	bb.put(gnss_att_brsght_state_x);
	bb.setOffset(104);	bb.put(gnss_att_brsght_state_y);
	bb.setOffset(108);	bb.put(gnss_att_brsght_state_z);
	bb.setOffset(112);	bb.put(gnss_att_brsght_x_stdv);
	bb.setOffset(116);	bb.put(gnss_att_brsght_y_stdv);
	bb.setOffset(120);	bb.put(gnss_att_brsght_z_stdv);
	bb.setOffset(124);	bb.put(gps_position_state_x_stdv);
	bb.setOffset(128);	bb.put(gps_position_state_y_stdv);
	bb.setOffset(132);	bb.put(gps_position_state_z_stdv);
	...
	bb.setOffset(156);	bb.put(gps_position_state_x);
	bb.setOffset(160);	bb.put(gps_position_state_y);
	bb.setOffset(164);	bb.put(gps_position_state_z);
	Checksum = computeChecksum((uint32_t*)buffer, 42);
	bb.setOffset(cIndex);		bb.put(Checksum);
	return status_ok;
}

int Msg_6424::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	bb.setOffset(100);	bb.get(gnss_att_brsght_state_x);
	bb.setOffset(104);	bb.get(gnss_att_brsght_state_y);
	bb.setOffset(108);	bb.get(gnss_att_brsght_state_z);
	bb.setOffset(112);	bb.get(gnss_att_brsght_x_stdv);
	bb.setOffset(116);	bb.get(gnss_att_brsght_y_stdv);
	bb.setOffset(120);	bb.get(gnss_att_brsght_z_stdv);
	bb.setOffset(124);	bb.get(gps_position_state_x_stdv);
	bb.setOffset(128);	bb.get(gps_position_state_y_stdv);
	bb.setOffset(132);	bb.get(gps_position_state_z_stdv);
	...
	bb.setOffset(156);	bb.get(gps_position_state_x);
	bb.setOffset(160);	bb.get(gps_position_state_y);
	bb.setOffset(164);	bb.get(gps_position_state_z);
