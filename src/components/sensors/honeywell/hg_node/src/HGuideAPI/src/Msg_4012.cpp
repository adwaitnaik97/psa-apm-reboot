...
bool Msg_4012::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	nav_init_config_tmp = ECTOS::BIT_UTILITIES::PackBool(nav_init_config_tmp, 7, nav_init_config.antenna_boresight, status_ok);
	nav_init_config_tmp = ECTOS::BIT_UTILITIES::PackBool(nav_init_config_tmp, 32, nav_init_config.nav_init, status_ok);
...
int Msg_4012::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	nav_init_config.antenna_boresight = ECTOS::BIT_UTILITIES::UnPackBool(nav_init_config_tmp, 7,  status_ok);
	nav_init_config.nav_init = ECTOS::BIT_UTILITIES::UnPackBool(nav_init_config_tmp, 32,  status_ok);
