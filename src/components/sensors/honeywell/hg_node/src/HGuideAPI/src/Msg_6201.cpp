...
const uint32_t Msg_6201::AddressId;
const uint32_t Msg_6201::MessageId;
const uint32_t Msg_6201::MessageLength;
...
bool Msg_6201::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_6201::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
