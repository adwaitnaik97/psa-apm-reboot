...
const uint32_t Msg_2402::AddressId;
const uint32_t Msg_2402::MessageId;
const uint32_t Msg_2402::MessageLength;
...
bool Msg_2402::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_2402::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
