...
const uint8_t Msg_0D::SyncByte;
const uint8_t Msg_0D::MessageID;
...
bool Msg_0D::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(2);	bb.put(static_cast<int16_t>CHECK_MAX_INT16(AngularRateX / (0.0005722046)));
	bb.setOffset(4);	bb.put(static_cast<int16_t>CHECK_MAX_INT16(AngularRateY / (0.0005722046)));
	bb.setOffset(6);	bb.put(static_cast<int16_t>CHECK_MAX_INT16(AngularRateZ / (0.0005722046)));
	bb.setOffset(8);	bb.put(static_cast<int16_t>CHECK_MAX_INT16(LinearAccelerationX / (0.01116211)));
	bb.setOffset(10);	bb.put(static_cast<int16_t>CHECK_MAX_INT16(LinearAccelerationY / (0.01116211)));
	bb.setOffset(12);	bb.put(static_cast<int16_t>CHECK_MAX_INT16(LinearAccelerationZ / (0.01116211)));
	...
	bb.setOffset(24);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaAngleX / (1.164153E-10)));
	bb.setOffset(28);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaAngleY / (1.164153E-10)));
	bb.setOffset(32);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaAngleZ / (1.164153E-10)));
	bb.setOffset(36);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaVelocityX / (2.270937E-09)));
	bb.setOffset(40);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaVelocityY / (2.270937E-09)));
	bb.setOffset(44);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaVelocityZ / (2.270937E-09)));
	int cIndex = 48;
	Checksum = 0;
...
int Msg_0D::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	bb.setOffset(2);	AngularRateX = static_cast<float>(bb.get<int16_t>()) * (0.0005722046);
	bb.setOffset(4);	AngularRateY = static_cast<float>(bb.get<int16_t>()) * (0.0005722046);
	bb.setOffset(6);	AngularRateZ = static_cast<float>(bb.get<int16_t>()) * (0.0005722046);
	bb.setOffset(8);	LinearAccelerationX = static_cast<float>(bb.get<int16_t>()) * (0.01116211);
	bb.setOffset(10);	LinearAccelerationY = static_cast<float>(bb.get<int16_t>()) * (0.01116211);
	bb.setOffset(12);	LinearAccelerationZ = static_cast<float>(bb.get<int16_t>()) * (0.01116211);
	...
	bb.setOffset(24);	DeltaAngleX = static_cast<double>(bb.get<int32_t>()) * (1.164153E-10);
	bb.setOffset(28);	DeltaAngleY = static_cast<double>(bb.get<int32_t>()) * (1.164153E-10);
	bb.setOffset(32);	DeltaAngleZ = static_cast<double>(bb.get<int32_t>()) * (1.164153E-10);
	bb.setOffset(36);	DeltaVelocityX = static_cast<double>(bb.get<int32_t>()) * (2.270937E-09);
	bb.setOffset(40);	DeltaVelocityY = static_cast<double>(bb.get<int32_t>()) * (2.270937E-09);
	bb.setOffset(44);	DeltaVelocityZ = static_cast<double>(bb.get<int32_t>()) * (2.270937E-09);
