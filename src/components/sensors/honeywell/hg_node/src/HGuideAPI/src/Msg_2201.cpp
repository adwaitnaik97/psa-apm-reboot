...
bool Msg_2201::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	time_validity_bits_tmp = ECTOS::BIT_UTILITIES::Pack(time_validity_bits_tmp, 4, 7, time_validity_bits.PPS_Mode, status_ok);
...
int Msg_2201::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	time_validity_bits.PPS_Mode = ECTOS::BIT_UTILITIES::UnPack(time_validity_bits_tmp, 4, 7,  status_ok);
