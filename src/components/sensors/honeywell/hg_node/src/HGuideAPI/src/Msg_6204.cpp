...
const uint32_t Msg_6204::AddressId;
const uint32_t Msg_6204::MessageId;
const uint32_t Msg_6204::MessageLength;
...
bool Msg_6204::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(36);	bb.put(Roll);
	bb.setOffset(40);	bb.put(Pitch);
	bb.setOffset(44);	bb.put(Heading);
	...
	bb.setOffset(52);	bb.put(EulerAnglesSTDVRoll);
	bb.setOffset(56);	bb.put(EulerAnglesSTDVPitch);
	bb.setOffset(60);	bb.put(EulerAnglesSTDVHeading);
	Checksum = computeChecksum((uint32_t*)buffer, 16);
	bb.setOffset(cIndex);		bb.put(Checksum);
	return status_ok;
}

int Msg_6204::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	bb.setOffset(36);	bb.get(Roll);
	bb.setOffset(40);	bb.get(Pitch);
	bb.setOffset(44);	bb.get(Heading);
	...
	bb.setOffset(52);	bb.get(EulerAnglesSTDVRoll);
	bb.setOffset(56);	bb.get(EulerAnglesSTDVPitch);
	bb.setOffset(60);	bb.get(EulerAnglesSTDVHeading);
