...
bool Msg_6211::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(20);	bb.put(systemTov);
	bb.setOffset(28);	bb.put(gpsTov);
	bb.setOffset(36);	bb.put(gps_week);
...
int Msg_6211::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(20);	bb.get(systemTov);
	bb.setOffset(28);	bb.get(gpsTov);
	bb.setOffset(36);	bb.get(gps_week);
