...
const uint32_t Msg_6504::AddressId;
const uint32_t Msg_6504::MessageId;
const uint32_t Msg_6504::MessageLength;
...
bool Msg_6504::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(32);	bb.put(NorthVelocity);
	bb.setOffset(36);	bb.put(EastVelocity);
	bb.setOffset(40);	bb.put(DownVelocity);
	...
	bb.setOffset(48);	bb.put(NorthVelocitySTDV);
	bb.setOffset(52);	bb.put(EastVelocitySTDV);
	bb.setOffset(56);	bb.put(DownVelocitySTDV);
	Checksum = computeChecksum((uint32_t*)buffer, 15);
	bb.setOffset(cIndex);		bb.put(Checksum);
	return status_ok;
}

int Msg_6504::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	bb.setOffset(32);	bb.get(NorthVelocity);
	bb.setOffset(36);	bb.get(EastVelocity);
	bb.setOffset(40);	bb.get(DownVelocity);
	...
	bb.setOffset(48);	bb.get(NorthVelocitySTDV);
	bb.setOffset(52);	bb.get(EastVelocitySTDV);
	bb.setOffset(56);	bb.get(DownVelocitySTDV);
