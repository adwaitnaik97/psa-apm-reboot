...
const uint8_t Msg_AC::SyncByte;
const uint8_t Msg_AC::MessageID;
...
bool Msg_AC::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_AC::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
