...
const uint8_t Msg_AD::SyncByte;
const uint8_t Msg_AD::MessageID;
...
bool Msg_AD::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(20);	bb.put(StatusWord1_tmp);
	...
	bb.setOffset(22);	bb.put(MultiPlexedStatusWord2_tmp);

	bb.setOffset(24);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaAngleX / (std::pow(2, -33))));
	bb.setOffset(28);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaAngleY / (std::pow(2, -33))));
	bb.setOffset(32);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaAngleZ / (std::pow(2, -33))));
	bb.setOffset(36);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaVelocityX / ((std::pow(2, -27)*0.3048))));
	bb.setOffset(40);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaVelocityY / ((std::pow(2, -27)*0.3048))));
	bb.setOffset(44);	bb.put(static_cast<int32_t>CHECK_MAX_INT32(DeltaVelocityZ / ((std::pow(2, -27)*0.3048))));
	int cIndex = 48;
	Checksum = 0;
...
int Msg_AD::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	uint16_t StatusWord1_tmp = 0; // temporary variable holding the custom bitfield
	bb.setOffset(20);	bb.get(StatusWord1_tmp);
	...
	uint16_t MultiPlexedStatusWord2_tmp = 0; // temporary variable holding the custom bitfield
	bb.setOffset(22);	bb.get(MultiPlexedStatusWord2_tmp);
	...
	bb.setOffset(24);	DeltaAngleX = static_cast<double>(bb.get<int32_t>()) * (std::pow(2, -33));
	bb.setOffset(28);	DeltaAngleY = static_cast<double>(bb.get<int32_t>()) * (std::pow(2, -33));
	bb.setOffset(32);	DeltaAngleZ = static_cast<double>(bb.get<int32_t>()) * (std::pow(2, -33));
	bb.setOffset(36);	DeltaVelocityX = static_cast<double>(bb.get<int32_t>()) * ((std::pow(2, -27)*0.3048));
	bb.setOffset(40);	DeltaVelocityY = static_cast<double>(bb.get<int32_t>()) * ((std::pow(2, -27)*0.3048));
	bb.setOffset(44);	DeltaVelocityZ = static_cast<double>(bb.get<int32_t>()) * ((std::pow(2, -27)*0.3048));
