...
const uint32_t Msg_6202::AddressId;
const uint32_t Msg_6202::MessageId;
const uint32_t Msg_6202::MessageLength;
...
bool Msg_6202::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_6202::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
