...
const uint8_t Msg_F0::SyncByte;
const uint8_t Msg_F0::MessageID;
...
void Msg_F0::Default()
{
	...
	for (unsigned int index = 0; index < 4; index++)
	{
		device_config[index] = 0;
	}
	Checksum = 0;
}

bool Msg_F0::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_F0::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
