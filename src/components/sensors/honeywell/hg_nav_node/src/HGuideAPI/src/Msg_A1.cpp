...
const uint8_t Msg_A1::SyncByte;
const uint8_t Msg_A1::MessageID;
...
bool Msg_A1::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_A1::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
