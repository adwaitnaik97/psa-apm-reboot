...
const uint8_t Msg_01::SyncByte;
const uint8_t Msg_01::MessageID;
...
bool Msg_01::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_01::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
