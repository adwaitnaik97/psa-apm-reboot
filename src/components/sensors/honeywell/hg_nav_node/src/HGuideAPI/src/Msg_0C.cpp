...
const uint8_t Msg_0C::SyncByte;
const uint8_t Msg_0C::MessageID;
...
bool Msg_0C::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_0C::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
