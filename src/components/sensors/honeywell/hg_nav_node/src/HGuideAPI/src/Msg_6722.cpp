...
const uint32_t Msg_6722::AddressId;
const uint32_t Msg_6722::MessageId;
const uint32_t Msg_6722::MessageLength;
...
bool Msg_6722::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_6722::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
