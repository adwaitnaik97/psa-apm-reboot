...
const uint32_t Msg_6109::AddressId;
const uint32_t Msg_6109::MessageId;
const uint32_t Msg_6109::MessageLength;
...
bool Msg_6109::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bitfieldAtByte60 = ECTOS::BIT_UTILITIES::PackBool(bitfieldAtByte60, 0, Data_Valid, status_ok);
...
int Msg_6109::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	Data_Valid = ECTOS::BIT_UTILITIES::UnPackBool(bitfieldAtByte60, 0,  status_ok);
