...
const uint32_t Msg_6203::AddressId;
const uint32_t Msg_6203::MessageId;
const uint32_t Msg_6203::MessageLength;
...
bool Msg_6203::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(36);	bb.put(NorthVelocity);
	bb.setOffset(40);	bb.put(EastVelocity);
	bb.setOffset(44);	bb.put(DownVelocity);
	...
	bb.setOffset(52);	bb.put(NorthVelocitySTDV);
	bb.setOffset(56);	bb.put(EastVelocitySTDV);
	bb.setOffset(60);	bb.put(DownVelocitySTDV);
	Checksum = computeChecksum((uint32_t*)buffer, 16);
	bb.setOffset(cIndex);		bb.put(Checksum);
	return status_ok;
}

int Msg_6203::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	bb.setOffset(36);	bb.get(NorthVelocity);
	bb.setOffset(40);	bb.get(EastVelocity);
	bb.setOffset(44);	bb.get(DownVelocity);
	...
	bb.setOffset(52);	bb.get(NorthVelocitySTDV);
	bb.setOffset(56);	bb.get(EastVelocitySTDV);
	bb.setOffset(60);	bb.get(DownVelocitySTDV);
