...
const uint32_t Msg_6405::AddressId;
const uint32_t Msg_6405::MessageId;
const uint32_t Msg_6405::MessageLength;
...
bool Msg_6405::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
	...
	bb.setOffset(48);	bb.put(EulerAnglesSTDVRoll);
	bb.setOffset(52);	bb.put(EulerAnglesSTDVPitch);
	bb.setOffset(56);	bb.put(EulerAnglesSTDVHeading);
	Checksum = computeChecksum((uint32_t*)buffer, 15);
	bb.setOffset(cIndex);		bb.put(Checksum);
	return status_ok;
}

int Msg_6405::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
	...
	bb.setOffset(48);	bb.get(EulerAnglesSTDVRoll);
	bb.setOffset(52);	bb.get(EulerAnglesSTDVPitch);
	bb.setOffset(56);	bb.get(EulerAnglesSTDVHeading);
