...
const uint8_t Msg_04::SyncByte;
const uint8_t Msg_04::MessageID;
...
bool Msg_04::Serialize(unsigned char * buffer, const unsigned int bufferSize)
{
...
int Msg_04::Deserialize(unsigned char * buffer, const unsigned int bufferSize)
{
	bool status_ok = true;
