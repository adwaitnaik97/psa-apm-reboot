...
enum gps_mode_table_t
{
	...
	GPS_MODE_5_PPP_CONVERGE = 5, //  RESERVED - Converging PPP Solution
	GPS_MODE_6_PPP_LOCK     = 6, //  RESERVED - PPP Locked solution
	GPS_MODE_7_RTK_WIDELANE = 7, //  RESERVED - RTK Widelane accuracy
