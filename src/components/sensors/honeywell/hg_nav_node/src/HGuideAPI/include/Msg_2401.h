#ifndef __HGuideAPI_Msg_2401_h__
#define __HGuideAPI_Msg_2401_h__
#pragma once
...
public:
	...
	static const uint32_t MessageId = 0x2401; // Message ID
...
#endif // __HGuideAPI_Msg_2401_h__
