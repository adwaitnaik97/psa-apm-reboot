...
public:
	...
	float residual_x; // [m] X axis KF measurement residual
	float residual_y; // [m] Y axis KF measurement residual
	float residual_z; // [m] Z axis KF measurement residual
	...
	float lever_arm_x; // DO NOT USE [m] X odometer lever arm
	float lever_arm_y; // DO NOT USE [m] Y odometer lever arm
	float lever_arm_z; // DO NOT USE [m] Z odometer lever arm
